    ...
    return (
        <main className="settings">
            <div className="settings__container">
                ...
                <div className="settings__color-theme">
                    <button
                        onClick={() => {
                            setTheme('light')
                        }}
                        className='settings__color-btn'>
                        <svg
                            className={`color-theme__svg ${theme === 'light' && 'color-theme__svg--active'}`}
                            version="1.1"
                            id="Layer_1"
                            x="0px"
                            y="0px"
                    ...
                    <button
                        ...
                        className='settings__color-btn'>
                        <svg
                            className={`color-theme__svg ${theme === 'system' && 'color-theme__svg--active'}`}
                            version="1.1"
                            id="Layer_1"
                            x="0px"
                            y="0px"
                    ...
                    <button
                        ...
                        className='settings__color-btn'>
                        <svg
                            className={`color-theme__svg ${theme === 'dark' && 'color-theme__svg--active'}`}
                            version="1.1"
                            id="Layer_1"
                            x="0px"
                            y="0px"
